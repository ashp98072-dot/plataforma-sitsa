...
DELETE FROM flota_inv_equipo WHERE empresa_id = @empresa_id;
DELETE FROM flota_inv_areas WHERE empresa_id = @empresa_id;
DELETE FROM flota_inv_categorias WHERE empresa_id = @empresa_id;
