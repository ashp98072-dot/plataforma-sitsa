    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-[var(--border)] bg-[var(--panel)] p-3 text-xs text-[var(--muted)]">
        <p>
          ...
          Debes llenar: Código de ruta y Cliente. Opcionalmente puedes agregar costo operativo, tarifario, piloto, auxiliares y sus viáticos habituales.
        </p>
        <p className="mt-1">
              ...
              <table className="min-w-full text-left text-xs">
                <thead className="bg-[var(--thead)] text-[var(--muted)]">
                  <tr>
                    ...
                    <th className="px-2 py-2">Costo operativo</th>
                    <th className="px-2 py-2">Tarifario</th>
                ...
                <tbody>
                  {filasPreview.map((f) => (
                    <tr key={f.filaExcel} className="border-t border-[var(--border)] align-top">
                      ...
                      <td className="px-2 py-2">{f.costoOperativoExcel == null ? "—" : `Q${f.costoOperativoExcel.toFixed(2)}`}</td>
