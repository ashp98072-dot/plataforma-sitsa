 ...
 * escritura de Programación (crear/editar viajes); la lectura general
 * sigue abierta vía requireTenantModulo(slug, "tms") para no romper la
 * pantalla de solo lectura de TMS que consume el mismo endpoint.
 */
